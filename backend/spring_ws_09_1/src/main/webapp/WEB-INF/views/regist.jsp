	...
	<div class="container">
		...
		<form method="post" action="regist" enctype="multipart/form-data">
			...
			<div class="input-group mb-3">
				<span class="input-group-text">차량번호</span> <input type="text"
					id="vin" name="vin" class="form-control">
			</div>
			<div class="input-group mb-3">
				<span class="input-group-text">모델명</span> <input type="text"
					id="modelName" name="modelName" class="form-control">
			</div>
			<div class="input-group mb-3">
			...
			<div class="input-group mb-3">
				<span class="input-group-text">주행 거리</span> <input type="number"
					id="mileage" name="mileage" class="form-control">
			</div>
			<div class="mb-3">
