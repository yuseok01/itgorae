...
INSERT INTO TEAM_APPLICATION (team_id, user_id, title, content) VALUES
(2, 1, '가입 신청 1', '팀에 가입하고 싶습니다.'),
(2, 2, '가입 신청 2', '팀의 활동에 참여하고 싶습니다.'),
(2, 3, '가입 신청 3', '함께 할 수 있기를 바랍니다.'),
(2, 4, '가입 신청 4', '저를 팀에 포함시켜 주세요.'),
(2, 1, '가입 신청 5', '열심히 하겠습니다.'),
(2, 2, '가입 신청 6', '팀과 함께 성장하고 싶습니다.'),
(2, 3, '가입 신청 7', '팀에 기여하고 싶습니다.'),
(2, 4, '가입 신청 8', '팀의 목표를 달성하고 싶습니다.'),
(2, 1, '가입 신청 9', '팀 활동에 열정적으로 임하겠습니다.'),
(2, 2, '가입 신청 10', '저를 팀의 일원으로 받아 주세요.');


INSERT INTO MATCH_REQUEST (team_id_from, team_id_to) VALUES
(3, 2),
(4, 2),
(5, 2),
(6, 2),
